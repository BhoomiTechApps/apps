...
`;
/* ---------- FINAL HTML WITH HIDDEN URL FIELDS ---------- */
...
function showSubmissionsTable() {
    ...
    let html = `
        ...
        <body>
        <h3>Parsed Submissions</h3>
        <!-- Hidden field carrying the script URL from main form -->
        <input type="hidden" id="dataScript" value="${savedDataScript || ""}">
        <table>
            <tr>
                <th>Survey Title</th>
                <th>Submitted At</th>
