 ...
 *              offers a reload. So replacing a file - for example a new vendor/translit-reverse.js - reaches
...
const CODE = [ 'index.html', 'styles.css', 'app.js', 'inplace.js', 'manifest.webmanifest', 'vendor/translit-reverse.js' ].map( url );
