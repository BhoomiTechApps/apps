/**
 * inplace.js - "type Roman, get Bengali script" inside ONE text area.
 *
...
( function ( root, factory ) {
	...
	function create( transliterate ) {
		...
		function showToken( before, after, start, roman ) {
			const converted = transliterate( roman );
		...
		function update( newValue, caret, inputType, composing ) {
			...
			const converted = transliterate( d.inserted );
			pending = null;
			value = before + converted + after;
