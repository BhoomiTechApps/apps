...
function initMap() {
    ...
    const LocateControl = L.Control.extend({
        ...
        onAdd: function(map) {
            ...
            button.innerHTML = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="display:block;margin:auto;"><circle cx="12" cy="12" r="7"></circle><circle cx="12" cy="12" r="11"></circle><circle cx="12" cy="12" r="1" fill="currentColor"></circle></svg>';
            button.style.cssText = 'cursor:pointer; background:white; text-align:center; display:flex; align-items:center; justify-content:center; width:30px; height:30px; color:#333;';
